...
insert into employee values ('James', 'E', 'Borg', 888665555, '1937-11-10', '450-Stone-Houston-TX', 'M', 55000, null, 1),
                           ...
                           insert into works_on values (123456789, 1, 32.5),
                            ...
                            (888665555, 20, 0.0);
use azure_company;
create table employee_departament as
SELECT * 
FROM employee
INNER JOIN departament ON employee.Super_ssn = departament.Mgr_ssn;


ALTER TABLE employee_departament
drop COLUMN Mgr_nome ;

create table departament_hours as
select * from employee_departament
inner join works_on on employee_departament.Ssn = works_on.Essn;
create table departament_loc as
SELECT 
    departament.Dname,
    dept_locations.Dlocation
from departament 
left join dept_locations on departament.Dnumber = dept_locations.Dnumber;
